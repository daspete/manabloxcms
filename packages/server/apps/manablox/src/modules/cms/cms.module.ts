...
import { BlockFieldTypeSchema } from './entities/content-type-field/content-type-field-types/block-field-type/block-field-type.model';
    ...
    MongooseModule.forFeature([
      ...
      },
      {
        ...
        discriminators: [
          ...
          { name: 'BlockField', schema: BlockFieldSchema }
        ],
      },
      {
        name: 'ContentType',
      ...
      },
      {
        ...
        discriminators: [
          ...
          { name: 'BlockFieldType', schema: BlockFieldTypeSchema }
        ],
      },
    ]),
  ],
